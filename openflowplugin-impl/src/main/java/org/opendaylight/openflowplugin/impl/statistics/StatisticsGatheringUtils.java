...
public final class StatisticsGatheringUtils {
    ...
    public static ListenableFuture<Void> deleteAllKnownFlows(final DeviceInfo deviceInfo,
        ...
        // Consequently, there were scenario which operational flow information was not available because  "deleteAllKnownFlows code and writeFlowStatistics" 
        // they did not executed sequentially.
        ...
        // This mentioned issue is easily reproducible in cluster environments with multiple switches and controllers having multi core process.
        // Single controllers tends to work, especially in vm with low number of cores.
